export const AvailableKindOfSociety = Object.freeze({
  ...
  ASOCIACION_EN_PARTICIPACION: 'Asociación en Participación',
  SOCIEDAD_ANONIMA_ABIERTA: 'Sociedad Anónima Abierta (S.A.A.)',
  CONSORCIO: 'Consorcio',
});

export const AvailableKindOfStore = Object.freeze({
